...
BCI | Breast | HE & IHC | [data](https://bci.grand-challenge.org/dataset/) | 9746 (4873 pairs), 3896 pairs for train and 977 for test| generation | paired images| patch | |2022 | pending application
BCSS [7] | Breast | H&E | [data](https://bcsegmentation.grand-challenge.org/), [paper](https://academic.oup.com/bioinformatics/article/35/18/3461/5307750) | 151 wsi, 20.000 patch| patch + segmentation mask | semantic seg | patch | (TCGA) | 2019 | downloading from drive
